...
class TestStandardTransaction:
    ...
    # this tests scenario when we contribute to our piggybank but we haven't reached the savings goal yet
    @pytest.mark.asyncio
    ...
    # this tests scenario when we reach the savings goal yet
    @pytest.mark.asyncio
    ...
    # test if we can steal from the piggybank coin
    @pytest.mark.asyncio
